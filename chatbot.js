    ...
    async function sendMessage() {
        ...
        if (!userMobile) {
            ...
            if (/^\d{10}$/.test(text)) {
                ...
                appendMessage("Please enter your 10-digit mobile number so I can check your details.", 'bot');
                return;
            }
        }
        ...
        // Send to Backend
        try {
            const res = await fetch('https://kanha-backend-yfx1.onrender.com/api/chat', {
                method: 'POST',
